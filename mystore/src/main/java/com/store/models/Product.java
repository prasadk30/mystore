...
public class Product {
	...
	public String toString() {
		return "Product [id=" + id + ", name=" + name + ", brand=" + brand + ", category=" + category + ", price="
				...
				+ imageFileName + ", getId()=" + getId() + ", getName()=" + getName() + ", getBrand()=" + getBrand()
				+ ", getCategory()=" + getCategory() + ", getPrice()=" + getPrice() + ", getDescription()="
				+ getDescription() + ", getCreatedAt()=" + getCreatedAt() + ", getImageFileName()=" + getImageFileName()
